...
public class JsCallJava {
    ...
    private Object mInjectedCls;
    private String mPreloadInterfaceJS;
    private Gson mGson;

    public JsCallJava(String injectedName, Object injectedCls) {
        try {
    ...
    public String call(WebView webView, String jsonStr) {
        if (!TextUtils.isEmpty(jsonStr)) {
            try {
                ...
                for (int k = 0; k < len; k++) {
                    ...
                    if ("string".equals(currType)) {
                        ...
                        try {
                            ...
                            values[k] = argsVals.isNull(k) ? null : argsVals.getJSONArray(k);
                        }
                ...
                return getReturn(jsonStr, 200, currMethod.invoke(mInjectedCls, values));
            } catch (Exception e) {
                //优先返回详细的错误信息
                if (e.getCause() != null) {
